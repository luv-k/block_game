...
public:
    TBlock() {
        ...
        cells[1] = { Position(0, 1), Position(1, 1), Position(2, 1), Position(1, 0) };
        cells[2] = { Position(1, 0), Position(1, 1), Position(1, 2), Position(0, 1) };
        cells[3] = { Position(0, 1), Position(1, 1), Position(2, 1), Position(1, 2) };
        Move(0, 3);
    }
};
...
public:
    JBlock() {
        ...
        cells[1] = { Position(1, 0), Position(1, 1), Position(1, 2), Position(0, 2) };
